...
| `apps/excel-addin/src/lib/stateBridge.ts`                      | Excel state sync with Custom Document Properties (includes Cpk thresholds) |
...
| `docs/products/excel/CPK_THRESHOLDS_IMPLEMENTATION.md`         | Cpk thresholds implementation details (Excel Add-in)                       |
...
- `docs/products/excel/CPK_THRESHOLDS_IMPLEMENTATION.md` - **Cpk Thresholds** (implementation details, testing)
- `docs/products/excel/EXCEL_STRATEGY.md` - **Excel Strategy** (feature parity, panel sizing, roadmap)
