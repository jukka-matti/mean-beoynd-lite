...
- **Focus Mode**: Any chart can be expanded to fill the entire dashboard area, temporarily replacing the grid layout.
...
```jsx
<div className="bg-slate-800/50 rounded-xl border border-slate-700 p-4">{/* Content */}</div>
```
