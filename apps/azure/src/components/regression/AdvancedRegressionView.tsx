                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        onClick={() => {}}
                        className="px-3 py-1.5 text-xs font-medium text-slate-400 hover:text-slate-300 hover:bg-slate-700 rounded-lg transition-colors"
                      >
                        Keep all
                      </button>
                    </div>
            ...
            {reductionHistory.length > 0 && (
              <div className="bg-slate-800 rounded-xl border border-slate-700 p-4">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-medium text-slate-300">Reduction History</h3>
                  <button
                  ...
                  {reductionHistory.map((step, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-center gap-2 text-slate-400">
                        <span className="text-slate-500 w-12">Step {i + 1}:</span>
                        <span>
                  ...
                  <tbody>
                    ...
                    {multiRegressionResult.coefficients.map(coef => {
                      ...
                      return (
                        <tr
                          key={coef.term}
                          className={`border-b border-slate-700/30 ${isSuggested ? 'bg-amber-500/10' : ''}`}
                        >
