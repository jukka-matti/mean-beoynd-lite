    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <button
          ...
          className="text-xs px-2 py-1 rounded bg-surface-tertiary text-content-secondary hover:bg-surface-secondary hover:text-white disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
            ...
            >
              ...
              <div
                className={`w-4 h-4 rounded border flex items-center justify-center flex-shrink-0 mt-0.5 ${
                  isSelected ? 'border-blue-500 bg-blue-500' : 'border-edge'
                }`}
              >
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Preview stats */}
                <div className="flex items-center gap-3 mt-1 text-xs text-content-muted font-mono">
