  ...
  return (
    <div className={`flex flex-col gap-1 ${className}`}>
      ...
      <div className="relative group">
        {/* Background bar */}
        <div className="h-2 w-full bg-surface-tertiary/50 rounded-full overflow-hidden">
          {/* Isolated segment */}
          <div
        ...
        >
          ...
          {/* Tooltip arrow */}
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 rotate-45 w-2 h-2 bg-surface-secondary border-r border-b border-edge" />
        </div>
      </div>
