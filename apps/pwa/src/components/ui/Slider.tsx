 ...
 *
 * Features:
 * - Tailwind styling for thumb/track
  ...
  return (
    <div className={`${className}`}>
      ...
      <div className="flex items-center justify-between mb-1.5">
        ...
        <span className="text-xs font-mono text-content">{displayValue}</span>
      </div>
      ...
      <div className="relative">
        <input
          ...
          className={`
            ...
            bg-surface-tertiary
            focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-1 focus:ring-offset-surface
            ...
            [&::-moz-range-track]:bg-surface-tertiary
