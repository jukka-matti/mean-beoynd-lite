...
> **Note:** Users set their own Cpk target (default 1.33) in PerformanceSetupPanel.
> The "below target" count is shown in the summary bar instead of health classification badges.
